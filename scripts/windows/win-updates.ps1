    ...
    switch ($global:RestartRequired) {
        ...
        1 {
            ...
            if (-not $prop) {
                ...
                Set-ItemProperty -Path $Registryey -Name $RegistryEntry -Value "C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe -File $($script:ScriptPath) -MaxUpdatesPerCycle $($MaxUpdatesPerCycle)"
            } else {
